        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
							  ...
							  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="recherche_par_fourniseur2.php" novalidate="novalidate">
                             
                                  <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
										      <h1 class="page-header">Entrez id de fourniseur</h1>
					 <input type="number" class="form-control" placeholder="Search..." name="donnes">
