        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
							  ...
							  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="participer_conference2.php" novalidate="novalidate">
                             
                                  <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
										      <h1 class="page-header">Entrez le num de charcheur</h1>
					 <input type="text" class="form-control" placeholder="Search..." name="donnes">
