...
$query1= mysqli_query($con, "SELECT max(`matricule_enseignant`) FROM `enseignant` WHERE 1");
...
$query2=mysqli_query($con, "INSERT INTO `enseignant` (`matricule_enseignant`, `nom_enseignant`, `prenom_eneignant`, `num_telephone_enseignant`, `mot_de_passe_enseignant`)"
." VALUES ('$matricule', '$nom', '$prenom', '$telephon', '$mot_passe');");
