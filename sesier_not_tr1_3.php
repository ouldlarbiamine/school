...
<body>
    ...
    <div id="wrapper">
	   ...
	   <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">forme d' ajoute des nots  </h1>
				
                </div>
                <!--End Page Header -->

    <form action="sesier_not_tr1_4.php" method="POST">
                        
          
                               
   <label class="control-label" for="success" > examen:</label>
   <input type="number" class="form-control" id="success" name="examen" />
   <label class="control-label" for="success" > devoir:</label>
   <input type="number" class="form-control" id="success" name="devoir" />
   <label class="control-label" for="success" >  not cc:</label>
   <input type="number" class="form-control" id="success" name="cc" />
   <label class="control-label" for="success" > cof :</label>
   <input type="number" class="form-control" id="success" name="cof" />
    

	<label class="control-label" for="success" >  id matier:</label>
...
$queryy1= mysqli_query($con,"SELECT `id_matiere`,`matricule_enseignant` FROM `obtenir` WHERE `matricule_enseignant`=$donnes");
			  while(   $row1=mysqli_fetch_assoc($queryy1))

{$id_matiere=$row1['id_matiere'];
	$queryy= mysqli_query($con,"SELECT `id_matiere`,`lbele` FROM `matiere` WHERE `id_matiere`='$id_matiere'");
			  while(   $row=mysqli_fetch_assoc($queryy))
					  {$lbele=$row['lbele'];
						  $niveau=$row2['libelle_niveau'];
						 echo "<option value=\"$id_matiere\" > ".$row1['id_matiere']." _ "."$lbele"." </option>";
...
?>
  ...
  <?php  //echo "SELECT `id_matiere`,`matricule_enseignant` FROM `obtenir` WHERE `matricule_enseignant`=$donnes";
