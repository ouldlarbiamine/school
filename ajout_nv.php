    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">forme d' ajoute niveu </h1>
				<form action="ajout_nv2.php" method="POST">
                        
          
                            
   <label class="control-label" for="success" > libelle_niveau:</label>
   <input type="text" class="form-control" id="success" name="niveu" /> 
   <label class="control-label" for="success" > id_niveau:</label>
   <input type="text" class="form-control" id="success" name="id_niveu" />
