...
$query1= mysqli_query($con, "SELECT max(`matricule`) FROM `survaillant` WHERE 1");
$tab=  mysqli_fetch_array($query1);
$matricule=$tab[0]+1;

 
$query2=mysqli_query($con, "INSERT INTO `survaillant` (`matricule`, `nom`, `prenom`, `telephone`, `mot_de_passe`)"
